...
<div id="c">
    <button style="font-size: large" onclick="window.location.href='shopping/delete'">退出</button>
    <button style="font-size: large" onclick="window.location.href='shopping/display'">购物车</button>
    <%--<a href="index.jsp"style="margin: 0 30px;border:1px solid white">退出</a>--%>
    <%--<a href="shopping/display">购物车</a>--%>
</div>
...
<div id="box1">
    ...
    <div class="ticket" >
        ...
        <td><a  href="ticket/buy?id=1&num=1&tickettype=平日普通票">购票</a></td><br>
    ...
    <div class="ticket">
        ...
        <td><a href="ticket/buy?id=2&num=1&tickettype=指定日普通票">购票</a></td><br>
        <li>仅适用于18-60岁的人士进行上山游玩</li>
    ...
    <div class="ticket">
        ...
        <td><a href="ticket/buy?id=3&num=1&tickettype=平日优惠票">购票</a></td><br>
    ...
    <div class="ticket">
        ...
        <td><a href="ticket/buy?id=4&num=1&tickettype=指定日优惠票">购票</a></td><br>
        <li>适用于未满18周岁或60周岁以上的人士</li>
        <li>适用于所有在校学生（需6周岁以上）</li>
        <li>限一人在任一指定日或平日入园一次</li>
        <li>购票及入园时请出示相关证件</li>
